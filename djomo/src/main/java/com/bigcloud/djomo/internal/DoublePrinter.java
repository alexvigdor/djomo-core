...
public class DoublePrinter {
	...
	static {
		final BigInteger[] POW5 = new BigInteger[POS_TABLE_SIZE];
		final BigInteger[] POW5_INV = new BigInteger[NEG_TABLE_SIZE];
	...
	/**
	 * Callers must assure buffer has 24 characters available before calling
	 * 
	 * @param val
	 * @param buf
	 * @param index
	 ...
	 */
	public static int printDouble(double val, char[] buf, int index) {
