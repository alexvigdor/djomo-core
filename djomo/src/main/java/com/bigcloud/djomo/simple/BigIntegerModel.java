...
public class BigIntegerModel extends NumberModel<BigInteger> {

	public BigIntegerModel(Type type, ModelContext context) {
		super(type, context);
	}
	...
	@Override
	public BigInteger parse(Buffer readBuffer, Buffer overflow) throws IOException {
		...
		return new BigInteger(overflow.toString());
	}
}
